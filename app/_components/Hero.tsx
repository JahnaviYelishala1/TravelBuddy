...
function Hero() {
    ...
    return (
        <div className='mt-24 flex ietms-center justify-center'>
            <div className='max-w-3xl w-full text-center space-y-6'>
                ...
                <p className='text-lg'>Tell me what you want, and I'll handle the rest: Flights, Hotels, tripPlanning in seconds</p>
                ...
                <div className='flex gap-5'>
                    {suggestions.map((suggestions, index) => (
                        <div key={index} className='flex ietms-center gap-2 border 
            rounded-full p-2 cursor-pointer hover:bg-primary hover:text-white'>
                ...
                <div className='flex items-center justify-center flex-col'>
                    ...
                    <HeroVideoDialog
                        ...
                        thumbnailSrc="https://www.youtube.com/watch?v=MvmNT7dioTE"
