...
import { aj } from "../../../lib/arcjet/route";
...
Along wth response also send which ui component to display for generative Ul for example 'budget/groupSize/tripDuration/final), where Final means Al generating complete final outpur Once all required information is collected, generate and return a strict JSON response only (no explanations or extra text) with following JSON scherma:
{ resp:Text Resp',
